...
The player thumbnails are requested from Wikipedia when the site is online. When offline, the cards show a neutral tennis-photo placeholder and keep the full name in the bottom name block.
...
## Update v7
- Rebranded the website and logo to Super Coach.
- Improved mobile layout with a compact step navigator and fixed bottom next buttons.
- Step 1 mobile view shows the live character preview before profile controls.
- Step 3 removes the selected-athlete preview and focuses on device toggles.
